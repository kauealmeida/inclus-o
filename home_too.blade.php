...
<script type="text/javascript">
    window.onload=function(){
        ...
        //Busca dinamica pela escola
        var filtro3 = document.getElementById('filtro-nome_escolas');
        var tabela3 = document.getElementById('lista');
        filtro3.onkeyup = function() {
            var nomeFiltro = filtro3.value;
            for (var i = 1; i < tabela3.rows.length; i++) {
                var conteudoCelula = tabela3.rows[i].cells[4].innerText;
                var corresponde = conteudoCelula.toLowerCase().indexOf(nomeFiltro) >= 0;
                tabela3.rows[i].style.display = corresponde ? '' : 'none';
            }
        };        
    }    
</script>
<body>
    ...
    <form class="form-inline">
        ...
        <div class="form-group mx-sm-3 mb-2">
            <input class="form-control" type="text" name="buscaEscola" id="filtro-nome_escolas" placeholder="Escola"value=""> 
        </div>
                        ...
                        <div  id="Detalhe-modal-xl{{ $aluno->id_alunos }}" class="modal fade Detalhe-modal-xl" role="dialog">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    ...
                                    <!--Informações geral sobre os alunos cadastrados-->
